          ...
          <div class="ds-bottom">
            <div class="db-left">
              ...
              <template v-else>
                ...
                <div v-else class="db-djs">
                  <counterboard :endtime="item.project_deadLine"><span slot="footer">后截止</span></counterboard>
                </div>
              </template>
            </div>
            <div class="db-right">
              ...
              <template v-else>
                <template v-if="item.sub.length>0">
                  <template v-if="isNull(item.project_winBidder)">
                    <div class="db-sxdd" v-if="item.refreshFlag==1"
                         v-tap="{methods:showConfirm,id:item._id,type:'refreshOrders'}">置顶订单
                    </div>
                    <div class="db-sxdd noRefresh" v-else>置顶订单</div>
                    <div class="db-qrdd"
                  ...
                  <template v-else>
                    ...
                    <div v-if="item.project_state==2" class="db-qrdd"
                         v-tap="{methods:showConfirm,id:item._id,type:'commitImprove'}">
                      确认完善
                    </div>
