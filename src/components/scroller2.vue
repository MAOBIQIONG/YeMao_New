      ...
      if (this.enableHorizontalSwiping) {
        ...
        this._xscroll.on('panstart', (e) => {
          ...
          if (e.direction === 8 || e.direction === 16) {
            e.preventDefault()
            if (this.scrollbarY) {
              this._xscroll.userConfig.scrollbarX = false
            }
            this._xscroll.userConfig.lockX = true
          }
        })
        this._xscroll.on('panend', (e) => {
            this.endEvent = e;
          if (this.scrollbarY) {
            this._xscroll.userConfig.scrollbarY = true
          }
          if (this.scrollbarX) {
            this._xscroll.userConfig.scrollbarX = true
          }
          ...
          if(this.startEvent.direction === 2 && (moveDistanceX > screenWidth*0.58 || moveTime < 80)){
